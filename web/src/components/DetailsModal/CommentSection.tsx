...
export default function CommentSection({ title }: CommentSectionProps) {
  ...
  const { data, size, setSize, mutate, isValidating } =
    useSWRInfinite<PaginatedComments>(getKey, fetcher, {
      ...
      {loggedIn ? (
        !userComment || isEditing ? (
            ...
            <div className="flex justify-end">
              <button
                ...
                disabled={
                  isSubmitting ||
                  !newComment.trim() ||
                  (userComment && newComment === userComment.content)
                }
          ...
          <div className="rounded-2xl border border-blue-100 bg-blue-50/30 p-4 dark:border-blue-900/30 dark:bg-blue-900/10">
            ...
            {renderCommentMeta(userComment.createdAt, userComment.updatedAt)}
