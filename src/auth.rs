...
mod tests {
    ...
    fn test_should_be_secure() {
        assert!(is_secure_logic("https://example.com"));
        assert!(!is_secure_logic("http://localhost:8787"));
        assert!(!is_secure_logic("http://example.com"));
    }

    fn is_secure_logic(base_url: &str) -> bool {
